    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profileVerification', models.CharField(choices=[('InProcessing', 'InProcessing'), ('Verified', 'Verified'), ('Rejected(Upload Details Again)', 'Rejected(Upload Details Again)')], default='InProcessing', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('referred_vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='referring_vendor', to='APP_EMTA.vendor')),
                ('referring_vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referred_vendors', to='APP_EMTA.vendor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='APP_EMTA.vendor')),
            ],
        ),
        migrations.CreateModel(
